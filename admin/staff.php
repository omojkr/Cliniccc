                 ...
                 <div class="container-fluid">                
                    ...
                    <!-- Table Content Row -->
                     <table class="table table-bordered">         
                            <tr class="cal">
                              <th class="cal">Staff</th>
                              <th class="cal">Duty Hours</th>                            
                            </tr>
                          ...
                          <tbody class="cal">
                            ...
                            ?>
                            <tr class="cal">
                                <td class="cal"><?php echo $row['staff_name']; ?></td>
                                <td class="cal"><?php echo $row['time']; ?></td>                              
                                <td class="cal">
                                    <form action = "" method = "POST">
                                        <input type = "hidden" name = "id" value = "<?php echo $row['id'];?>"/>
                                        <input type = "submit" button class="button buttonapprove" name = "approve" value = "View"/>
                                        <input type = "submit" button class="button buttondeny" name = "deny" value = "Remove"/>
                                </td>
